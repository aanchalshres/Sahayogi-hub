...
import type { NGO, Task } from '@/types';
...
import { mockStats, mockNGOs, mockTasks, mockActivities } from '@/app/data/mockData';
import {
  Users,
  Heart,
  Building2,
...
function Dashboard({ }: DashboardProps) {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setNgos(mockNGOs.filter((n) => n.status === 'pending').slice(0, 3));
  ...
  const ngoColumns = [
    ...
    },
    {
      ...
      header: 'Location',
      render: (ngo: NGO) => (
        <span className="text-sm text-gray-600">{ngo.district}</span>
      ),
    },
    {
      key: 'submittedAt',
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-3 mt-6">
          ...
          <Button
            onClick={() => router.push('/admin/ngo-verification')}
            ...
            <div className="p-6">
              {isLoading ? (
                ...
                <EmptyState
                  ...
                  onAction={() => router.push('/admin/ngo-verification')}
                />
              ) : (
                <DataTable
                  columns={ngoColumns}
