...
const menuItems = [
  ...
  { name: "Post Task", href: "/dashboard/org/post-task", icon: Plus },
  { name: "My Tasks", href: "/dashboard/org/tasks", icon: FileText },
  { name: "Applications", href: "/dashboard/org/applications", icon: Users },
  { name: "Verify Volunteers", href: "/dashboard/org/verify", icon: CheckSquare },
  { name: "Profile", href: "/dashboard/org/profile", icon: User },
];
  ...
  return (
    ...
    >
      ...
      <div className="p-2 border-t border-[#CACDD3]">
        <button className="flex items-center gap-3 text-sm text-[#6B7280] hover:text-[#111827] w-full px-2 py-2 rounded-lg hover:bg-[#AAB2C8] transition">
